...
â€¢ Datos de identificación: nombre completo, número de identificación, cargo y empresa.
â€¢ Datos de contacto: correo electrónico, número de teléfono y dirección.
â€¢ Datos de navegación: dirección IP, tipo de navegador, páginas visitadas, tiempo de sesión y datos de cookies.
â€¢ Datos contractuales: información proporcionada durante la contratación y ejecución de los servicios, como requerimientos técnicos, documentos de proyecto y comunicaciones.
â€¢ Datos financieros: información necesaria para la facturación y procesamiento de pagos, en cumplimiento de las obligaciones tributarias aplicables.
...
â€¢ Gestionar la relación contractual y prestar los servicios contratados.
â€¢ Enviar cotizaciones, propuestas comerciales y comunicaciones relacionadas con los servicios.
â€¢ Gestionar el proceso de facturación y cobro de honorarios.
â€¢ Cumplir con obligaciones legales, tributarias y regulatorias vigentes en Colombia.
â€¢ Mejorar la calidad de nuestros servicios a través del análisis de uso y retroalimentación del Cliente.
â€¢ Enviar comunicaciones comerciales, boletines o novedades tecnológicas, únicamente con el consentimiento previo del titular.
â€¢ Garantizar la seguridad de los sistemas y prevenir fraudes o accesos no autorizados.`,
  },
  {
    id: "base-legal",
...
â€¢ Ejecución de un contrato: cuando el tratamiento es necesario para la prestación de los servicios contratados.
â€¢ Consentimiento del titular: para el envío de comunicaciones comerciales o el uso de cookies no esenciales.
â€¢ Obligación legal: cuando el tratamiento es requerido por la normativa colombiana vigente (obligaciones tributarias, reportes a autoridades, etc.).
â€¢ Interés legítimo: para la mejora de nuestros servicios y la seguridad de nuestros sistemas.`,
  },
  {
    id: "conservacion",
...
â€¢ Datos contractuales: se conservarán durante la vigencia de la relación contractual y por un período adicional de 5 años para efectos legales y tributarios.
â€¢ Datos de navegación y cookies: se conservarán por un máximo de 12 meses, salvo que el titular solicite su eliminación con anterioridad.
â€¢ Comunicaciones comerciales: se conservarán hasta que el titular revoque su consentimiento.
...
â€¢ Acceso: conocer qué datos personales suyos están siendo tratados por CloudCO.
â€¢ Actualización y corrección: solicitar la corrección de datos inexactos o incompletos.
â€¢ Supresión: solicitar la eliminación de sus datos cuando no sean necesarios para las finalidades del tratamiento, sujeto a las obligaciones legales vigentes.
â€¢ Revocación del consentimiento: retirar el consentimiento otorgado para el tratamiento, sin efecto retroactivo.
â€¢ Oposición: oponerse al tratamiento de sus datos para finalidades específicas, como el envío de comunicaciones comerciales.
â€¢ Portabilidad: solicitar una copia de sus datos en formato estructurado y de uso común.
...
â€¢ Cookies esenciales: necesarias para el funcionamiento básico del sitio. No requieren consentimiento.
â€¢ Cookies analíticas: permiten medir el tráfico y comportamiento de los visitantes para mejorar la experiencia del sitio (ej. Google Analytics). Requieren consentimiento.
â€¢ Cookies de preferencias: almacenan configuraciones personalizadas del usuario dentro del sitio.
...
â€¢ Proveedores de servicios tecnológicos que colaboran en la prestación del servicio (ej. servicios de nube, herramientas de gestión de proyectos), bajo estrictos acuerdos de confidencialidad y tratamiento de datos.
â€¢ Autoridades competentes cuando sea requerido por ley o por orden judicial.
â€¢ Socios comerciales o subcontratistas, únicamente con el consentimiento previo del titular y en el marco de un proyecto específico.
...
â€¢ Cifrado de datos en tránsito mediante protocolos TLS/HTTPS.
â€¢ Control de acceso basado en roles, con autenticación de múltiples factores para sistemas internos.
â€¢ Revisiones periódicas de seguridad y pruebas de vulnerabilidad.
â€¢ Políticas internas de manejo de información confidencial para todo el equipo.
â€¢ Procedimientos de respuesta ante incidentes de seguridad.
